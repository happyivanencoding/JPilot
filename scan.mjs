...
// Preserve the scanner's existing public exports, backed by the one canonical writer.
export { sanitizeMarkdownField, sanitizeTsvField, formatCompensation, trustIsFlagged, formatTrustSegment, formatPipelineOffer, formatScanHistoryRow, appendToPipeline, appendToScanHistory } from './lib/pipeline-store.mjs';
import { sanitizeMarkdownField, sanitizeTsvField, formatCompensation, trustIsFlagged, formatTrustSegment, formatPipelineOffer, formatScanHistoryRow, appendToPipeline, appendToScanHistory } from './lib/pipeline-store.mjs';
