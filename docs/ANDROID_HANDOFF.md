...
Updated: 2026-09-09 (Europe/Paris). Current Android source, APK and actual USB installation: **0.3.6 / versionCode 10**. Current public backend build: **0.3.6** and Web counterpart **0.4.4**. Read `ANDROID_LANGUAGE_SEPARATION.md` for the independent UI/material language contracts. Earlier release evidence below remains historical, not invalidated.
