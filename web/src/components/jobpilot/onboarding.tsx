...
export function V1FirstRunOverlay({onDone}:{onDone:()=>void|Promise<void>}) {
  ...
  const pick=async(file:File)=>{setUploading(true);await p.upload(file,sourceLanguage,locale,contracts,searchArea);setUploading(false);};
