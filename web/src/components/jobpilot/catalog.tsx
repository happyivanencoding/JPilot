...
export function ApplicationsPage() {
  ...
  const unrated=rows(data.jobs).filter(job=>job.evaluationState!=="evaluated" && safeExternalUrl(String(job.url || "")) && !activeEvaluations.some(task=>task.jobId===job.id || task.input?.url===job.url));
