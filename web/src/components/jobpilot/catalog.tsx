...
function OfferCard({offer,index=0}:{offer:Json;index?:number}) {
  ...
  const score=offer.historyStale?undefined:offer.matchScore?.current ?? deep.currentScore;
