      ...
      <section className="dot-bg relative overflow-hidden rounded-2xl border border-border bg-surface/40 px-7 py-10 md:px-10 md:py-12">
        ...
        <div className="relative z-10">
          <p className="font-mono text-xs uppercase tracking-[0.2em] text-muted">
            <span className="text-faint">//</span> local · votre machine
          </p>
          <h1 className={`${instrumentSerif.className} mt-3 text-4xl leading-[1.05] text-landing md:text-5xl`}>
            Ajoutez votre CV. Découvrez qui recrute.
          </h1>
          <p className="mt-4 max-w-xl text-[15px] leading-relaxed text-muted">
            Aucun compte supplémentaire à configurer : le texte, les PDF et les documents sont analysés localement via
            <span className="text-foreground"> AgentDock ACP · Codex</span>. Le scan du marché reste <span className="text-foreground">gratuit</span> ; les tokens ne sont utilisés que pour les fonctions IA.
          </p>
          <div className="mt-7">
            <CvIngest />
          </div>
