    ...
    <div>
      ...
      <div className="co-aibox p-4">
        <div className="mb-2 flex items-center gap-2 text-[12px] font-medium text-brand">
          <Sparkles className="size-3.5" /> Décrivez le poste — AgentDock lance Codex sur le web public
        </div>
        <textarea
          ref={ref}
          rows={2}
        ...
        <div className="mt-3 flex flex-wrap items-center justify-between gap-3">
          <span className="text-[12px] text-muted">
            <span className="font-medium text-foreground">AgentDock ACP → Codex</span> · GPT-5.6 Luna · mode lecture seule · utilise les tokens Codex.
          </span>
          <button
            type="button"
