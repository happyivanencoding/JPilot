...
export function roleCvReviewPrompt({basis,master,draft,job,locale='en',userProvidedFacts=''}) {
...
${userProvidedFacts?`The following facts were explicitly supplied and confirmed by the user for this draft. They are valid candidate evidence at exactly the strength stated, even if they were absent from the uploaded CV. Do not infer anything beyond them:\n${userProvidedFacts}\n`:''}
