...
export function candidateConstraints(offer,input) {
  ...
  if(junior&&(seniorTitle||experienceYears.length)) {
    forceClosest=true;seniorityFit='above-target';penalty+=35;
  ...
  if(marketing&&/\b(sales|commercial|business development|account executive|sdr|bdr)\b/.test(title)&&!/marketing/.test(title)) {
    forceClosest=true;roleFit='outside-primary';penalty+=18;
  ...
  if(languageRisk){penalty+=30;notes.push('Français professionnel demandé ou rédaction locale : niveau actuel probablement inférieur à l’exigence.');}
