...
import { careerOpsRoot, readInbox, readPipelineApplications } from "@/lib/career-ops";
 ...
 */
export function assembleDedupContext(profileId?: string): { urls: Set<string>; lines: string[] } {
